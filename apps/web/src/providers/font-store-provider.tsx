...
export const FontStoreContext = createContext<FontStoreApi | undefined>(undefined);
...
export function FontStoreProvider(props: Readonly<FontStoreProviderProps>) {
  ...
  const storeRef = useRef<FontStoreApi>(createFontStore(storageKey, initialState));
