...
export interface TipMessageProps extends React.HTMLAttributes<HTMLSpanElement>, VariantProps<typeof tipMessageVariants> {}
...
const TipMessage = forwardRef<HTMLDivElement, TipMessageProps>((props, ref) => {
	...
	return (
		<span
			className={tipMessageVariants({ variant, size, className })}
			ref={ref}
			{...rest}
		>
