...
export interface OptionSelectorProps<T extends string> extends VariantProps<typeof optionSelectorVariants> {
		...
		<React.Fragment>
			<div className='flex items-center gap-x-200'>
				...
				<div className='flex flex-col items-start gap-y-075'>
					<Text className='text-option-selector-default-text'>
						{option.name}
					</Text>
